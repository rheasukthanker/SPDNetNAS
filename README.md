...
of facial expressions classified into 7 distinct classes i.e. angry, fear, disgust, surprise, neutral, happy and sad. You can get the AFEW dataset by ask the official organizer <a href="mailto:shreya.ghosh@iitrpr.ac.in">Shreya Ghosh</a> and emotiw2014@gmail.com . Unzip the dataset and place it in the <b>data/<b> folder </li>
</ul>
