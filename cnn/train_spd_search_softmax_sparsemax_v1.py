...
from model_spd_v0_radar_search_softmax_sparsemax_v1 import Network
...
def use_constraint_optimization_as_convex_layer_direct_sparsemax(x, n):
    ...
    w, = layer(x)
    #w_num=torch.exp(-w)
    #w_den=torch.sum(torch.exp(-w),dim=0)
    #y=w_num/w_den
    y = sparsemax(-w)
    #print(y)
    return y
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        print(
            use_constraint_optimization_as_convex_layer_direct_sparsemax(
