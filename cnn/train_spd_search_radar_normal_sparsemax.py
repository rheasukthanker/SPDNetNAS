...
from model_spd_v0_radar_search_normal_sparsemax import Network
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        print(sparsemax(model.alphas_normal))
        print(sparsemax(model.alphas_reduce))
        print(torch.sum(sparsemax(model.alphas_normal), dim=1))
        print(torch.sum(sparsemax(model.alphas_reduce), dim=1))
        # training
